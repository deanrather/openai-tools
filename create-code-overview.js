...
if (process.argv.length <= 2) {
  console.log('Usage: node create-code-overview.js </path/to/file>');
  process.exit(1);
}
...
const prompt = `
create a code overview
filename:${fileName}
format the document nicely, using paragraphs, lists, etc
...
async function createCodeOverview() {
  ...
  try {
    ...
    console.log(`Overview saved to ${outputFilePath}`);
